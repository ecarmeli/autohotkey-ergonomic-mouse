...
# =========================================================================
$RemoteUrl           = "https://raw.githubusercontent.com/ecarmeli/autohotkey-ergonomic-mouse/main/User%20Mode%20(no%20UAC)/ErgonomicMouse-User.ahk"
$TargetDir           = "$env:LOCALAPPDATA\ErgonomicMouse"
$AHKScriptTargetPath = "$TargetDir\ErgonomicMouse-User.ahk"
$AHKExecutable       = "$TargetDir\AutoHotkey\AutoHotkey64.exe"
